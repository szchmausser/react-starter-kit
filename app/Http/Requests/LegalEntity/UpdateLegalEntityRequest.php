...
class UpdateLegalEntityRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'registration_number' => 'nullable|string|max:50|unique:legal_entities,registration_number,'.$id,
            ...
            'email_1' => 'nullable|email|max:255|unique:legal_entities,email_1,'.$id,
            'email_2' => 'nullable|email|max:255|unique:legal_entities,email_2,'.$id,
