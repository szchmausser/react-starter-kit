...
class StoreIndividualRequest extends FormRequest
{
    ...
    {
        return [
            'national_id' => 'required|string|max:20|unique:individuals,national_id',
            'passport' => 'nullable|string|max:30|unique:individuals,passport',
            ...
            'rif' => 'nullable|string|max:15|unique:individuals,rif',
            'email_1' => 'nullable|email|max:255|unique:individuals,email_1',
            'email_2' => 'nullable|email|max:255|unique:individuals,email_2',
