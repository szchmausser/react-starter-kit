...
export default function LegalEntitiesIndex() {
    ...
    const columns = useMemo(
        () => [
            ...
            columnHelper.accessor((row) => getEntityName(row), {
                id: 'business_name',
                header: 'Nombre',
                cell: (info) => (
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative p-4 sm:p-6">
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-end gap-2">
                        ...
                        <Link href={route('legal-entities.create')}>
                            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground hidden sm:inline-flex" title="Nueva Entidad">
                                <Plus className="mr-2 h-4 w-4" />
                                Nueva Entidad
                            </Button>
                            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground sm:hidden" size="icon" title="Nueva Entidad">
                ...
                {hasActiveFilters && (
                    <div className="mb-4 rounded bg-white p-3 shadow dark:bg-zinc-900">
                ...
                <div className="mb-24 block space-y-2 sm:hidden">
                    ...
                    <div className="mb-2 rounded bg-white p-3 shadow dark:bg-zinc-900">
                        <div className="space-y-2">
                            ...
                            <div className="mt-4">
                                <label htmlFor="mobile-per-page" className="mb-1 block text-xs text-gray-500">
                    ...
                    {tableRows.length > 0 ? (
                        tableRows.map((row, index) => {
                            ...
                            return (
                                <div key={entity.id} className="flex flex-col gap-2 rounded bg-white p-3 shadow dark:bg-zinc-900">
                                    <div
                                    ...
                                    >
                                        ...
                                        <span className={expandedTitles[entity.id] ? '' : 'truncate'}>{getEntityName(entity)}</span>
                                    </div>
                                    <div
                                        ...
                                        onClick={(e) => toggleTitleExpand(entity.id, e)}
                                    >
                                        <div className={expandedTitles[entity.id] ? '' : 'truncate'}>RIF: {entity.rif}</div>
                                    </div>
                    ...
                    <div className="bg-sidebar fixed right-0 bottom-0 left-0 z-10 w-full rounded-t-lg border-t border-gray-200 p-3 shadow-md sm:hidden dark:border-zinc-800 dark:bg-zinc-800">
                            ...
                            <div className="text-xs whitespace-nowrap text-gray-500">
                                <span className="inline-flex items-center">
                                    <span className="xs:inline hidden">
                                        {legalEntities?.meta?.from || 0}-{legalEntities?.meta?.to || 0}
                                    </span>
                        ...
                        <div className="mt-2 flex justify-between">
                            <Button
                                ...
                                disabled={
                                    !legalEntities.meta?.links?.find((link) => link.label === '1')?.url || legalEntities.meta?.current_page === 1
                                }
                            >
                    ...
                    <div className="bg-sidebar flex flex-row-reverse items-center justify-between gap-4 border-t border-gray-200 px-4 py-4 sm:rounded-b-lg dark:border-zinc-800 dark:bg-zinc-800">
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                                <div>
                                    Mostrando{' '}
                                    {legalEntities?.meta?.to && legalEntities?.meta?.from
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {legalEntities?.meta?.links && <LaravelPagination links={legalEntities.meta.links} onPageChange={handlePageNavigation} />}
                        </div>
                    </div>
                </div>
                ...
                <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Esta acción no se puede deshacer. Esto eliminará permanentemente la entidad{' '}
                                <b>{entityToDelete ? getEntityName(entityToDelete) : ''}</b> de la base de datos.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
