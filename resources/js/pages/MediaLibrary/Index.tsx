        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 sm:p-6 relative min-h-[calc(100vh-120px)]">
                ...
                <div className="hidden sm:block overflow-hidden shadow-sm">
                    ...
                    <div className="flex flex-row-reverse items-center justify-between px-4 py-4 gap-4 bg-sidebar dark:bg-zinc-800/70 border-t border-gray-200 dark:border-zinc-800 sm:rounded-b-lg">
            ...
            <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-sidebar dark:bg-zinc-800 shadow-md p-3 rounded-t-lg border-t border-gray-200 dark:border-zinc-800 z-10">
                <div className="flex items-center justify-between">
