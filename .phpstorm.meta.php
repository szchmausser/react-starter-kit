...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Desarrollo\react-starter-kit\public\storage' => 'string',
            ...
            'media-library.conversions_disk' => 'string',
            'media-library.responsive_images_disk' => 'string',
            'media-library.domain' => 'NULL',
            'media-library.full_url' => 'NULL',
            'media-library.job_queue' => 'NULL',
            'media-library.register_media_collections_events' => 'boolean',
            'media-library.sanitize_paths_on_save' => 'boolean',
            'media-library.sanitize_paths_on_url_generation' => 'boolean',
            'media-library.video_driver' => 'string',
            'media-library.delete_temporary_directories_older_than_days' => 'integer',
...
'app.aliases.Vite','app.local_timezone','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.disks.media.throw','filesystems.disks.media.report','filesystems.links.C:\\Desarrollo\\react-starter-kit\\public\\storage',
...
'media-library.enable_vapor_uploads','media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','media-library.conversions_disk',
'media-library.responsive_images_disk','media-library.domain','media-library.full_url','media-library.job_queue','media-library.register_media_collections_events',
'media-library.sanitize_paths_on_save','media-library.sanitize_paths_on_url_generation','media-library.video_driver','media-library.delete_temporary_directories_older_than_days','media-library.conversion_file_namer',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','eloquent-sortable.order_column_name',
'eloquent-sortable.sort_when_creating','eloquent-sortable.ignore_timestamps','model-status.status_model','model-status.status_attribute','model-status.model_primary_key_attribute',
...
'generated::9eWrSqz0aBex0Ui9','home','media-library.index','media-library.create','media-library.clean-orphaned-files',
'media-library.store','media-library.edit','media-library.show','media-library.destroy','media-library.download',
'media-library.info','media-library.update','dashboard','dashboard.urgent-deadlines','dashboard.past-due-deadlines',
'dashboard.case-status-distribution','dashboard.case-type-distribution','tags.index','tags.create','tags.store',
'tags.show','tags.edit','tags.update','tags.destroy','tags.relations',
'todo-lists.index','todo-lists.store','todo-lists.update','todo-lists.destroy','todo-lists.todos.index',
'todo-lists.todos.store','todo-lists.todos.update','todo-lists.todos.destroy','search.index','search.results',
'users.show','individuals.index','individuals.create','individuals.store','individuals.show',
'individuals.edit','individuals.update','individuals.destroy','legal-entities.index','legal-entities.create',
'legal-entities.store','legal-entities.show','legal-entities.edit','legal-entities.update','legal-entities.destroy',
'legal-cases.index','legal-cases.create','legal-cases.store','legal-cases.show','legal-cases.edit',
'legal-cases.update','legal-cases.destroy','case-participants.add-form','case-participants.search','case-participants.associate',
'case-participants.remove','legal-cases.update-sentence-date','legal-cases.update-closing-date','legal-cases.statuses','legal-cases.set-status',
'legal-cases.available-statuses','case-events.store','case-events.update','case-events.destroy','legal-cases.important-dates.index',
'legal-cases.important-dates.store','legal-cases.important-dates.set-expired','legal-cases.important-dates.update','legal-cases.important-dates.destroy','legal-cases.important-dates.list',
'legal-cases.all-tags','legal-cases.tags','legal-cases.attach-tags','legal-cases.detach-tag','legal-cases.sync-tags',
'status-lists.index','status-lists.create','status-lists.store','status-lists.show','status-lists.edit',
'status-lists.update','status-lists.destroy','case-types.index','case-types.create','case-types.store',
'case-types.show','case-types.edit','case-types.update','case-types.destroy','statuses.index',
'statuses.create','statuses.store','statuses.show','statuses.edit','statuses.update',
'statuses.destroy','legal-cases.media.index','legal-cases.media.create','legal-cases.media.store','legal-cases.media.show',
'legal-cases.media.edit','legal-cases.media.update','legal-cases.media.destroy','legal-cases.media.download','generated::aCiFX4vWYULU1ttU',
'profile.edit','profile.update','profile.destroy','password.edit','password.update',
'appearance','register','generated::SwVO1LMHhE5wx2Mq','login','generated::xuah5IaQh5gREFxH',
'password.request','password.email','password.reset','password.store','verification.notice',
'verification.verify','verification.send','password.confirm','generated::MeEEzgKNBkizE1Pn','logout',
'storage.local',);
...
'APP_BEHIND_EXPOSE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
